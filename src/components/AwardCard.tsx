  ...
  return (
    <div className="relative w-full aspect-square perspective-1000">
      ...
      >
        ...
        <Card 
          className="absolute inset-0 w-full h-full backface-hidden hover:shadow-xl transition-shadow duration-300 overflow-hidden"
          style={{ 
        ...
        <Card 
          className="absolute inset-0 w-full h-full backface-hidden rotate-y-180 hover:shadow-xl transition-shadow"
          style={{ 
            backfaceVisibility: 'hidden',
