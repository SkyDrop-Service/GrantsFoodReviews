...
const Admin = () => {
  ...
  const { count: qrVisits, loading: qrLoading } = useQrScans();
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <Card className="mb-6">
              <CardHeader className="pb-2">
                <CardTitle className="text-lg">QR Visits</CardTitle>
                <CardDescription>Total number of QR code scans</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">
                  {qrLoading ? '...' : qrVisits.toLocaleString()}
                </div>
              </CardContent>
            </Card>
